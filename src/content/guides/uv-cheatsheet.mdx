...
<InfoBox type="highlight" title="Come Pensare a uv">
...
<InfoBox type="success" title="Tip">
`uv run` crea automaticamente il venv se non esiste e installa le dipendenze.
È il modo più semplice per lavorare: basta `uv run python script.py` e sei operativo.
</InfoBox>
